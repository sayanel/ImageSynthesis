...
PROJECTS := aogl glfw glew imgui stb

.PHONY: all clean help $(PROJECTS)

all: $(PROJECTS)

aogl: glfw glew stb imgui
	@echo "==== Building aogl ($(config)) ===="
	@${MAKE} --no-print-directory -C . -f aogl.make
...
clean:
	@${MAKE} --no-print-directory -C . -f aogl.make clean
