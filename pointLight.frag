...
vec3 pointLight(vec3 n, vec3 p, vec3 diffuseColor, vec3 specularColor, float specularPower){
...
void main(void)
{
	...
	vec3 color =  pointLight(n, p, diffuseColor, specularColor, specularPower);
